...
class RSVPForm extends FormBase {
  ...
  /**
   * Function that get the formi id.
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['email'] = [
      '#title' => t('Email Andress'),
      '#type' => 'textfield',
      '#size' => 25,
      '#description' => t('We will send updates to the email address you provides'),
      '#required' => TRUE,
    ];
  ...
  /**
   * Function that validates all the informations inserted at the form.
   */
  ...
  /**
   * Function that submits the form with all informations.
   */
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    \Drupal::database()->insert('rsvplist')->fields(
      ...
      ->execute();
    \Drupal::messenger()->addMessage(t('Thanks for your RSVP, you are on the list for the event.'));
  }
